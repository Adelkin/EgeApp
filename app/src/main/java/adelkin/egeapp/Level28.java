...
public class Level28 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level28);//установили текст
        ...
        btnclose.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View v){
                ...
                try {
                    ...
                    Intent intent = new Intent(Level28.this, GameLevels.class); // создаем намерение для перехода
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level28.this, Level29.class);
        ...
        btn_back.setOnClickListener (new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                try {
                    ...
                    Intent intent = new Intent(Level28.this, GameLevels.class); //Создали намерение
                    startActivity(intent);
                    finish();//закрыть этот класс
        ...
        final Animation a = AnimationUtils.loadAnimation(Level28.this, R.anim.alpha);
